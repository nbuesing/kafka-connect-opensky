...
public enum RecordField {
    ...
    LONGITUDE("longitude", SchemaBuilder.float64().doc("geographical location in WSG-84 decimal degrees.").build()),
    LATITUDE("latitude", SchemaBuilder.float64().doc("WGS-84 longitude in decimal degrees.").build()),
